 ...
 * @since       1.5
 */
class BrewProViewBrews extends JViewLegacy
{
	/**
	...
	public function display($tpl = null)
	{
        ...
        BrewProHelper::addSubmenu('brews');
        $model = $this->getModel();
        ...
        public function addToolbar(){ //this is the dynamic toolbar.
            ...
            JToolbarHelper::title(JText::_('BrewPro-Brews'), 'pushpin banners');
            
            if(JRequest::getVar('view')=="brews" and JRequest::getVar('layout')==""):
            JToolbarHelper::addNew('brews.add');
            JToolbarHelper::deleteList('Are you sure you want to delete this Brew(s)?','brews.delete',"Delete");
            JToolbarHelper::publish('brews.publish', 'JTOOLBAR_PUBLISH', true);
            JToolbarHelper::unpublish('brews.unpublish', 'JTOOLBAR_UNPUBLISH', true);
		...
		JHtmlSidebar::addFilter(
            ...
            JToolbarHelper::apply('brews.apply');
            JToolbarHelper::save('brews.save');
            JToolbarHelper::cancel('brews.cancel');
